...
## 0.1.0-rc.11（2026-09-14，本地候选，未公开发布）
...
分发范围：Windows amd64 CLI/TUI/GUI、原生 Linux amd64/glibc CLI/TUI。GUI 仍需 WebView2；便携包包含 GUI，setup 仅安装 CLI/TUI，制品未签名。远端下载以 GitHub Releases 实际上传为准。
